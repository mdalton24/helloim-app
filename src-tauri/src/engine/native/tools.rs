...
//! `win_shell.rs`'s own header for the specific list the release reviewer's runtime pass
...
/// `OpenSettingsPage` — SAFE AGENCY LAYER, `the safety spec`,
...
mod tests {
    ...
    /// **THE SAME SHAPE FOR THE SAFE AGENCY LAYER — the safety spec,
