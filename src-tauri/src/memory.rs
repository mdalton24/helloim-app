...
//!
//! The user's memory-engine brief, 2026-08-27. This is the first tier built, and it
...
//! at the end. That costs a turn every time, and the user's own standing rule is
...
/* ── THE BRIDGE FILE IS UNTRUSTED INPUT, AND EVERY BOUND BELOW IS ON THE READ
   ...
   The security reviewer, 2026-08-28, demonstrated against this file's own compiled code:
...
pub fn bridge_prompt(workdir: &str, can_save: bool) -> Option<String> {
    ...
    /* THE FRAMING IS THE SECURITY CONTROL, AND IT USED TO POINT THE WRONG WAY.
       ...
       who can write to that folder could have put there. The security reviewer's proof
...
/// The security reviewer's finding against `bridge_prompt` (see the block comment above
...
mod tests {
    ...
    ///
    /// This is the security reviewer's 2026-08-28 proof turned into a regression test. Her
