...
//!
//! The user, 2026-08-26, after hearing what Windows offers: "yes include kokora and
...
/* ── WHAT THESE TWO HASHES ARE, AND WHAT THEY ARE NOT. ────────────────────────
   ...
   The security reviewer, 2026-08-28: this path fetched ~115 MB from somebody else's GitHub
...
/// The user reported the voices silent twice, 2026-08-26. The engine was never at
...
///
/// The user, 2026-08-26: "can we package this into our installer so they dont have
