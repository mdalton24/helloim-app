...
// Moving it here — rather than rewriting it — is the designer's spec, build order
...
// remount (switching Giles back to Bella) reruns the exact code path that
...
export function mount(canvas) {
  ...
  try { handle = mountAurelia(canvas, state, {}); }
    ...
    // THIS USED TO BE catch (e) {} — the visual designer, 2026-09-05, tracking down "Bella's
  ...
  // COST CONTROL, applied here too — the designer's spec §3.4: "apply the same
