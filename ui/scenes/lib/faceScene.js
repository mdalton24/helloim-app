...
// use. THIS app's own source tree is ES modules throughout —
...
function createScene(canvas, build) {
  ...
  try {
    ...
    // THIS USED TO BE catch {} — the visual designer, 2026-09-05, auditing every scene for
    ...
    // (bella.js, blitz, capcom, cyclops, giles, koan, noir, phreak,
  ...
  /* AND PAUSE WHEN HOME ITSELF ISN'T THE ACTIVE VIEW -- the visual designer, 2026-09-05,
     The user's own report via the front-end reviewer: leaving Home for another in-app screen
  ...
  /* THE APPEARANCE HOOK, FORWARDED — a later design review (index.html's
   * dock, applyAppearance()) — AND ONLY ATTACHED WHEN THE SCENE ITSELF
   * IMPLEMENTS ONE. The outside reviewer, round 95 follow-up: the dock's Appearance menu
